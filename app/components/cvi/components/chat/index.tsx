...
export const ChatPanel = memo(() => {
	...
	return (
		<aside
			...
			aria-hidden={!isOpen}
			// react-dom@18 doesn't treat `inert` as a boolean attribute and warns on a
			// boolean value — emit it as a string when closed, omit it when open.
			// (`inert` is typed boolean, so cast the string-valued prop.)
